...
def queryset_to_workbook(queryset, columns, header_style=None,
    ...
    """
    Export queryset data to xls workboos
    :param queryset: queryset to export
    :param columns: column which be displayed in workbook
    :param header_style: style header cells
    :param default_style: default cell style
    :param cell_style_map: marring cell formats
    :return: 
    """
    workbook = xlwt.Workbook()  # init workbook
